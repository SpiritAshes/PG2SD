...
class AachenImages (Dataset):
    ...
    """
    def __init__(self, select='db day night', root='datasets/aachen'):
...
class AachenPairs_StyleTransferDayNight (AachenImages_DB, StillPairDataset):
    ...
    """
    def __init__(self, root='datasets/aachen/style_transfer', **kw):
...
class AachenPairs_OpticalFlow (AachenImages_DB, PairDataset):
    ...
    """
    def __init__(self, root='datasets/aachen/optical_flow', **kw):
